    ...
    if($check >= 1)
    {
    ...
    else
      {
       if($password === $confpassword)
          {
            $role =$set_role ;
              $query = "insert into $role (fullName,address,city,gender,email ,password,role) values('$name','$address','$city','$gender','$email','$encPass','$set_role')";
...
<a href="login">
          ...
          <div class="card col-md-8 col-sm-12 mx-auto">
              <div class="card-body px-5 py-5">
                ...
                <div class="form-outline flex-fill mb-4">  
                        ...
                        if(isset($_POST['btn'])){
                        echo $_POST['name'];} ?>" required placeholder="Enter your name">
                            </div>
                            <div class="form-outline flex-fill mb-4">  

                        <input type=" text" class="form-control" name="email" required value="<?php if(isset($_POST['btn'])){
                        echo $_POST['email'];} ?>"  placeholder="example@example.com">
                        </div>
                        <div class="form-outline flex-fill mb-4">  
                        ...
                        <input type=" password" class="form-control" name="password" required value="<?php if(isset($_POST['btn'])){
                          echo $_POST['password'];} ?>" 
                            ...
                            <div class="form-outline flex-fill mb-4">  
                        <input type=" password" class="form-control" name="confpassword" required value="<?php if(isset($_POST['btn'])){
                        echo $_POST['confpassword'];} ?>" 
                            placeholder="Must contain atleast 8 characters" minlength="8">
                            </div>
                            <div class="form-outline flex-fill mb-4">  
                        <input type=" number" class="form-control" name="number" required value="<?php if(isset($_POST['btn'])){
                        echo $_POST['number'];} ?>" placeholder="Enter your Phone Number">
                        </div>
                       <div class="form-outline flex-fill mb-4">  
                        <input type="text" class=" form-control"name="city"  placeholder="Enter city" value="<?php if(isset($_POST['btn'])){
                            echo $_POST['city'];} ?>" >
                         </div>
  ...
  <div class="form-outline flex-fill mb-4">  
                        <input type="text" class=" form-control"name="address"  placeholder="Address" value="<?php if(isset($_POST['btn'])){
                            echo $_POST['address'];} ?>" >
                         </div>
